<div class="faq">
    <div class="vector_depoimentos">
        <img src="img/vectorDepoimentos.png" alt="">
    </div>
    <div class="faq_content">
        <div class="faq_top">
            <img src="img/faqTop.png" alt="">
        </div>
        <div class="lines_faq">
            <x-icons path="lines.svg" />
        </div>
        <div class='container body_faq'>
            <div class='title_content'>
                <x-icons path="faqIcon.svg" />
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionOne">
                            <div class="accordion_text">
                                <div class="accordion-body">
                                    <img class="accordion_image" src="img/timeLine1.png" />
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut
                                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercition
                                        ullamco
                ...
                <div class="accordion" id="accordionTwo">
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
                            <div class="accordion-body">
                                <img class="accordion_image" src="img/timeLine2.png" />
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut
                                    labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercition
                ...
                <div class="accordion" id="accordionThree">
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionThree">
                            <div class="accordion-body">
                                <img class="accordion_image" src="img/timeLine3.png" />
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut
                                    labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercition
                ...
                <div class="accordion" id="accordionFour">
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFour">
                            <div class="accordion-body">
                                <img class="accordion_image" src="img/timeLine4.png" />
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut
                                    labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercition
